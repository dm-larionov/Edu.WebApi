...
namespace Edu.WebApi.Infrastructure.Persistence.Tests;

public class ConnectionStringSecurerTests
{
    private const string Mssql = "Data Source=(localdb)\\mssqllocaldb;Initial Catalog=EducationProcessDemo;MultipleActiveResultSets=True;";
