...
public class UsersController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(EduAction.View, EduResource.Users)]
    ...
    [HttpGet("{id}/roles")]
    [MustHavePermission(EduAction.View, EduResource.UserRoles)]
    ...
    [MustHavePermission(EduAction.Update, EduResource.UserRoles)]
    ...
    [HttpPost]
    [MustHavePermission(EduAction.Create, EduResource.Users)]
    ...
    [MustHavePermission(EduAction.Update, EduResource.Users)]
    [ApiConventionMethod(typeof(EduApiConventions), nameof(EduApiConventions.Register))]
