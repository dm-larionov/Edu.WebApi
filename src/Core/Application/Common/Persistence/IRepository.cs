namespace Edu.WebApi.Application.Common.Persistence;
...
public interface IRepositoryAud<T> : IRepositoryBase<T>
...
public interface IReadAudRepository<T> : IReadRepositoryBase<T>
    where T : class, IAuditableEntity
{
}
