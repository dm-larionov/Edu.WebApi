...
using EducationProcess.Application.Interfaces.Services.Storage;
using EducationProcess.Application.Interfaces.Services.Storage.Provider;

namespace Edu.WebApi.Infrastructure.Services.Storage
{
    /*
