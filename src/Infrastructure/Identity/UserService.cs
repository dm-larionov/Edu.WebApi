...
using Edu.WebApi.Application.Common.FileStorage;
using Edu.WebApi.Application.Common.Interfaces;
using Edu.WebApi.Application.Common.Mailing;
using Edu.WebApi.Application.Common.Models;
using Edu.WebApi.Application.Common.Specification;
using Edu.WebApi.Application.Identity.Users;
using Edu.WebApi.Domain.Identity;
...
internal partial class UserService : IUserService
{
    ...
    public async Task ToggleStatusAsync(ToggleUserStatusRequest request, CancellationToken cancellationToken)
    {
        ...
        bool isAdmin = await _userManager.IsInRoleAsync(user, EduRoles.Admin);
        if (isAdmin)
        {
